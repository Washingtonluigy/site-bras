...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      {open && (
        <div className="bg-white rounded-2xl shadow-2xl w-72 overflow-hidden animate-fade-in">
          ...
          <div className="p-4 bg-[#ECE5DD]">
            <div className="bg-white rounded-xl px-3 py-2 shadow-sm max-w-[85%] text-sm text-gray-700 leading-relaxed">
              Olá! Precisa de ajuda para escolher seu iPhone? Fale conosco pelo WhatsApp!
            </div>
          </div>
      ...
      <button
        ...
        className="w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20b958] shadow-lg flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95"
